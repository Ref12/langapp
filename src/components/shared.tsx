...
export function WordCard({ word, state, pinyin, source, run, busy }: {
  ...
  return <article className="word-card">
    ...
    <p lang="zh-Hans" className="example">{word.example}</p><p className="small muted">{word.translation}</p>
    ...
    <details><summary>Skill progress</summary><SkillState state={state} /></details>
  </article>
}
