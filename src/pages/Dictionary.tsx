...
export function Dictionary({ workspace, run, busy }: PageProps) {
  ...
  return <>
    ...
    <p className="page-footnote">The curriculum collection contains the 205 beginner senses, not every meaning in the reference dictionary. Original starter examples retain their own IDs and progress; they do not automatically count toward curriculum senses. <a href="#curriculum-sources">Sources and licenses</a>.</p>
  </>
}
